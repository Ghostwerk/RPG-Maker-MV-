...
/*:
 * @author S_Rank_Crazy
 * @plugindesc v0.3 Displays indicators above events
...
(function($, $core)
{
	...
	$core.registerPlugin($, "SRCrazy_EventIndicators", "0.3", "2016-01-19", true, ["SRCrazy_Core"]);
	...
	Game_Event.prototype.setupPage = function()
	{
		...
		else if (displayIndicator === "false" && $._activeIndicators[this._eventId])
		{
			$.removeIndicator(this._mapId, this._eventId);
		}
	};
