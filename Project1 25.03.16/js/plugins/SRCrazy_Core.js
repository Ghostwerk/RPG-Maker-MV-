...
/*:
 * @author S_Rank_Crazy
 * @plugindesc v1.1.0 Required for most SRCrazy scripts. Provides some additional functions to standard classes.
 * <SRCrazy_Core>
 * 
...
(function($)
{
	...
	$.registerPlugin($, "SRCrazy_Core", "1.1.0", "2016-01-04", true);
...
///////////////////////////////////////////////////////////////////////////////
//							Addiontal Game_Event Functinality
// [EVNT]	Here
// [LKUP	Top
...
(function($)
{
	 ...
	 */
	$.getCommentParameter = function(parameter)
	{
		var regex = new RegExp('<' + parameter + ': (.*)>', 'i');
		
		var comments = this.getCommentsOnPage();
		var i = comments.length;
		while (i-- > 0)
		{
...
(function($)
{
	...
	$.TweenEasing = {
		linear: function(progress)
		{
			...
			return this._start + (this._diff * progress);
		}
	};
	 ...
	 * @param {String} name Name of the propr#erty on the target object
	 ...
	 */
	Tween.prototype.onUpdateCallback = function() {};
	
	/**
	 * Invoked when Tween completes. To be overridden by users.
	 */
	Tween.prototype.onCompleteCallback = function() {};
